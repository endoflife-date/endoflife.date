...
latestLinkTemplate: "https://www.nv5geospatialsoftware.com/docs/whatsnew_{{'__LATEST__'|drop_zero_patch|replace:'.','_'}}.html"

# eol(x) = max(releaseDate(x+1), latestDate(x))
releases:
  - releaseCycle: "9.2"
  ...
  - releaseCycle: "8.5"
    ...
    eol: 2018-07-01
    latest: "8.5.0"
    latestDate: 2018-07-01

  - releaseCycle: "8.4"
    releaseDate: 2014-09-22
    eol: 2017-07-01
    latest: "8.4.0"
    latestDate: 2017-07-01
