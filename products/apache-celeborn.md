...
The project currently maintains multiple concurrent release branches (e.g. 0.4.x, 0.5.x, 0.6.x) with active
backporting of fixes, following a pattern similar to other Apache projects that support the current
and previous 2 minor versions. Versions are considered EOL only when branch maintenance ceases entirely.
