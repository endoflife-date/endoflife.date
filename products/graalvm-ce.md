...
GraalVM Community Edition can be downloaded from the [graalvm-ce-builds GitHub repository](https://github.com/graalvm/graalvm-ce-builds/releases/).
It must not be confused with [Oracle GraalVM](/oracle-graalvm), which is released under a different license.
