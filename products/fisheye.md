...
# Release dates from https://my.atlassian.com/download/feeds/{current,archived}/fisheye.json.
# The feed is used rather than the download page: since the product was discontinued that page no
# longer carries a version list, so scraping it finds nothing at all.
...
auto:
  methods:
    - json_versions: https://my.atlassian.com/download/feeds/current/fisheye.json
      selector: '$[*]'
      name: '$.version'
      date: '$.released'
    - json_versions: https://my.atlassian.com/download/feeds/archived/fisheye.json
      selector: '$[*]'
      name: '$.version'
      date: '$.released'
