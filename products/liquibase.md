...
Liquibase OSS is published under the Apache License 2.0; Liquibase Pro is a commercial extended
version of Liquibase. Both follow the same release cycle running a standard semantic versioning
scheme with the current release cycle being the only one actively maintained. Breaking changes
happen in minor releases too.
