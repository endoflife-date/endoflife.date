...
auto:
  methods:
    - json_versions: https://my.atlassian.com/download/feeds/current/crowd.json
      selector: '$[*]'
      name: '$.version'
      date: '$.released'
    - json_versions: https://my.atlassian.com/download/feeds/archived/crowd.json
      selector: '$[*]'
      name: '$.version'
      date: '$.released'
...
# Release dates from https://my.atlassian.com/download/feeds/{current,archived}/crowd.json.
