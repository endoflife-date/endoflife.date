...
The last two LTS releases and the last two feature releases are supported.
Security patches are provided for the past three LTS releases and two feature
releases.

## [Versioning](https://pulsar.apache.org/contribute/release-policy/#release-semantics)

The Pulsar project follows a variant of Semantic Versioning (semver), replacing
`major.minor.patch` with `LTS.feature.patch`.
