...
This entry focuses on the core OS lifecycle; AppSupport (Android compatibility layer) versions evolve alongside (e.g., AppSupport 13 in 5.x for newer devices).
