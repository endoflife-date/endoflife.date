...
changelogTemplate: "https://www.suse.com/releasenotes/{% if MajorReleaseCycle < 16 %}x86_64/SUSE-SLES/{{'__RELEASE_CYCLE__'|replace:'.','-SP'|replace:'-SP0',''}}/{%else%}sles/__RELEASE_CYCLE__/{%endif%}"
latestColumn: false
