...
latestLinkTemplate: "https://docs.centreon.com/docs/__RELEASE_CYCLE__/releases/centreon-os/#{{'__LATEST__'|replace:'.',''}}"
...
releases:
  - releaseCycle: "25.10"
    ...
    latestLink: https://docs.centreon.com/docs/releases/centreon-os/
  ...
  - releaseCycle: "22.04"
    ...
    latestLink: "https://docs.centreon.com/docs/__RELEASE_CYCLE__/releases/centreon-core/#{{'__LATEST__'|replace:'.',''}}"
  ...
  - releaseCycle: "21.10"
    ...
    eoes: 2023-11-30
    latest: "21.10.17"
    latestDate: 2023-11-17
    latestLink: https://archives-docs.centreon.com/21.10/docs/releases/centreon-core/#211017
  ...
  - releaseCycle: "21.04"
    ...
    latestLink: https://archives-docs.centreon.com/21.04/docs/releases/centreon-core/#210420
  ...
  - releaseCycle: "20.10"
    ...
    latestLink: https://archives-docs.centreon.com/20.10/docs/releases/centreon-core/#201018
  ...
  - releaseCycle: "20.04"
    ...
    latestLink: https://archives-docs.centreon.com/20.04/docs/releases/centreon-core/#200420
  ...
  - releaseCycle: "19.10"
    ...
    eoes: 2021-04-30
    latest: "19.10.23"
    latestDate: 2021-05-04
    latestLink: https://docs-older.centreon.com/docs/centreon/en/latest/release_notes/centreon-19.10.html
  ...
  - releaseCycle: "19.04"
    ...
    latestLink: https://docs-older.centreon.com/docs/centreon/en/latest/release_notes/centreon-19.04.html
  ...
  - releaseCycle: "18.10"
    ...
    eoes: 2020-04-30
    latest: "18.10.12"
    latestDate: 2020-02-24
    latestLink: https://docs-older.centreon.com/docs/centreon/en/latest/release_notes/centreon-18.10.html
