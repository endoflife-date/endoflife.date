...
# are generated by the latestLinkTemplate. Note that this validation is not done by default because
...
module EndOfLifeHooks
  ...
  def self.validate(product)
    ...
    error_if.is_not_an_url('latestLinkTemplate') if product.data.has_key?('latestLinkTemplate')
  ...
  class Validator
    ...
    def is_url_invalid(property)
      # strip is necessary because latestLinkTemplate is sometime reformatted on two lines by update-product-data.py
